...
if (this.config.showGaugeShadow == true)
{
	...
	if (this.config.label && this.config.label != "")
	{
		...
		this.gaugeLBL.setAttributeNS(null, 'style',  "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 11) + "px; font-weight:bold; fill-opacity:1.0; fill:" + this.config.labelColor + "; text-anchor:middle;");
	...
	this.gaugeVAL.setAttributeNS(null, 'y',      this.config.offsetY + this.config.canvasH / 1.3);
	...
	if (this.config.showMinMax == true)
	{
		...
		this.gaugeMAX.setAttributeNS(null, 'style',  "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 11) + "px; font-weight:bold; fill-opacity:1.0; fill:" + this.config.minmaxColor + "; text-anchor:middle;");
	...
	if (this.config.showMinMax == true)
	{
		...
		this.gaugeMIN.setAttributeNS(null, 'style',  "font-family:Arial,Verdana; font-size:" + Math.floor(this.config.canvasW / 11) + "px; font-weight:bold; fill-opacity:1.0; fill:" + this.config.minmaxColor + "; text-anchor:middle;");
